...
class ConstructorStandings(models.Model):
    constructorstandingsid = models.IntegerField(db_column='constructorStandingsId', blank=True, null=True)  # Field name made lowercase.
    raceid = models.IntegerField(db_column='raceId', blank=True, null=True)  # Field name made lowercase.
    constructorid = models.IntegerField(db_column='constructorId', blank=True, null=True)  # Field name made lowercase.
    points = models.IntegerField(blank=True, null=True)
    position = models.IntegerField(blank=True, null=True)
    positiontext = models.IntegerField(db_column='positionText', blank=True, null=True)  # Field name made lowercase.
...
class DriverStandings(models.Model):
    driverstandingsid = models.IntegerField(db_column='driverStandingsId', blank=True, null=True)  # Field name made lowercase.
    raceid = models.IntegerField(db_column='raceId', blank=True, null=True)  # Field name made lowercase.
...
class SprintResults(models.Model):
    sprintresultid = models.IntegerField(db_column='sprintResultId', blank=True, null=True)  # Field name made lowercase.
    raceid = models.IntegerField(db_column='raceId', blank=True, null=True)  # Field name made lowercase.
    driverid = models.IntegerField(db_column='driverId', blank=True, null=True)  # Field name made lowercase.
    constructorid = models.IntegerField(db_column='constructorId', blank=True, null=True)  # Field name made lowercase.
    number = models.IntegerField(blank=True, null=True)
    grid = models.IntegerField(blank=True, null=True)
    position = models.IntegerField(blank=True, null=True)
    positiontext = models.CharField(db_column='positionText', max_length=50, blank=True, null=True)  # Field name made lowercase.
    points = models.IntegerField(blank=True, null=True)
    time = models.CharField(max_length=50, blank=True, null=True)
